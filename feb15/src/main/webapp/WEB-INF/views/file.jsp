...
<html lang="ko">
    <head>
        ...
        <title>Trinity Company - file업로드</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <!-- 파일업로드 -->
        <section class="page-section" id="file">
            <div class="d-flex justify-content-center">
               <div class="text-center">
               		<form action="./file" method="post" enctype="multipart/form-data" onsubmit="fileCheck()">
               		<div class="input-group">
  						<input type="file" accept="image/*" id="file1" name="file1" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
